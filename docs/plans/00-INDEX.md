...
| 비용 | 상한 **100원 = 68,966 micro-USD**(9/20 상향, 06 §3.2). 배심원은 `jury:{post_id}` 로 따로 40원. 9/20 실측 초기 SENTENCE 약 34원 |
...
| [21 — 반복 반려 복구](21-repeated-rejection-fix.md) | 논리 작성 시도별 캐시·형량 검사 적용 조건·근거 타입·골든셋 회귀 | 9/20 | 21 §3.1~3.4 | AI 파트 |
