...
| `backend-contract.md`  | 백엔드가 알아야 할 것을 같은 커밋으로 기록. 상시 계약은 10(`docs/plans/10-backend-contract.md`), 기능별 할 일은 날짜별 전달 문서(19, 20, …) | 없음. 늘 로드 |
...
| `geoji-issue`   | GitHub 이슈를 새로 열거나 이미 올라온 이슈를 고쳐 달라는 요청. 제목 형식·본문 양식·라벨 |
